...
image: /public/assets/images/waf.webp
draft: false
lang: ""
---
# 静态网站能不能被打死？
...
![](/public/assets/images/waf-3.webp)

但是我们可以 **曲线救国** ，先设置一个规则将所有请求默认拦截，再判断是不是大陆IP，如果是，则跳过这个规则

![](/public/assets/images/waf-4.webp)

![](/public/assets/images/waf-5.webp)
...
![](/public/assets/images/waf-8.webp)
...
![](/public/assets/images/waf-7.webp)