...
image: /public/assets/images/fenliu.webp
draft: false
lang: ""
---
...
![](/public/assets/images/fenliu-4.webp)

![](/public/assets/images/fenliu-5.webp)

![](/public/assets/images/fenliu-16.webp)
### 动态型

国内使用IPv6回源（用户 - IPv4 - EO/ESA CDN - IPv6 - 源站）。至于为什么不用ESA，是因为ESA CDN回源非标端口需要像Cloudflare一样写一条回源规则，占用免费规则集5条中的其中之一
![](/public/assets/images/fenliu-6.webp)
海外采用Cloudflare Tunnel（用户 - IPv4 - CF CDN - 内部连接 - 源站）
![](/public/assets/images/fenliu-7.webp)

# 浏览器客户端实现监看当前访问节点

利用浏览器JavaScript发送HEAD请求拿取对端响应头Server字段并回显（若跨域则需要设置 **Access-Control-Expose-Headers** 响应头，值为 **server**
![](/public/assets/images/fenliu-12.webp)

![](/public/assets/images/ae6f93ce318fa428e94256c2b4a501e1.webp)
...
![](/public/assets/images/fenliu-11.webp)

![](/public/assets/images/fenliu-10.webp)
...
![](/public/assets/images/fenliu-13.webp)
...
![](/public/assets/images/fenliu-14.webp)

![](/public/assets/images/fenliu-15.webp)
# 成果展示

### 博客本体

![](/public/assets/images/https___blogacoforkcom__多地区多线路HTTP测速(1).webp)
### Umami
![](/public/assets/images/https___umamiacoforkcom__多地区多线路HTTP测速.webp)
### 随机图
![](/public/assets/images/https___picacoforkcom__多地区多线路HTTP测速.webp)