...
image: /public/assets/images/hook-steam-drm.webp
tags:
  - Steam
draft: false
lang: ""
...
![](/public/assets/images/hook-steam-drm-4.webp)

前往 [Wu-Yijun/steam_client_loader](https://github.com/Wu-Yijun/steam_client_loader)

下载最新的文件名带有 **Windows** 的 **Release**
![](/public/assets/images/hook-steam-drm-1.webp)

解压，剔除无关文件

![](/public/assets/images/hook-steam-drm-2.webp)
...
![](/public/assets/images/hook-steam-drm-5.webp)

随后运行， `steamclient_loader.exe` 即可在不启动Steam的情况下直接拉起游戏

![](/public/assets/images/VMWSQyHhF5.gif)