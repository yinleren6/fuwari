...
但 Obsidian 的默认行为就是哪怕是粘贴绝对路径，如 `/public` 也不会自动添加前面的斜杠，所以我们需要找AI写一个小插件自动加上，否则会因为路径拼接错误导致图片404： https://github.com/yinleren6/fuwari-Astro/tree/main/.obsidian/plugins/fix-public-links/main.js
