...
image: /public/assets/images/212792e5-8634-4121-984b-c3477f463897.webp
tags:
  - 解包
  - 魔法少女的魔女审判
draft: false
...
会打开你的文件资源管理器并导向该游戏位于系统中的实际路径 ![](/public/assets/images/manosaba-unzip-2.webp)
点击 `地址栏` 然后复制
![](/public/assets/images/manosaba-unzip-3.webp)
此时在 **AssetRipper** 中我们选择 `文件 - 打开文件夹` 并粘贴路径，并进入 `*_Data` 文件夹，这里为 **manosaba_Data** 
![](/public/assets/images/manosaba-unzip.webp)

![](/public/assets/images/manosaba-unzip-5.webp)
接下来会进入漫长的等待时间。网页会卡在加载，我们可以查看一并打开的命令窗口确认资源载入进度
当你发现 **查看已导入文件** 可被点击后，方可继续
![](/public/assets/images/manosaba-unzip-6.webp)
选择右上角的 `导出 - 导出所有文件`
![](/public/assets/images/manosaba-unzip-7.webp)
点击选择文件夹，随便选个位置放解包后的文件
![](/public/assets/images/manosaba-unzip-8.webp)
然后点击 **导出主要内容**
![](/public/assets/images/manosaba-unzip-9.webp)
最终，寻找类似 `Assets` 文件夹，就有所有的资源文件了（如CG图，MV，角色语音等）
![](/public/assets/images/manosaba-unzip-10.webp)
