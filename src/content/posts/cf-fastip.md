...
draft: false
image: /public/assets/images/cf-fastip-11.webp
lang: ""
...
![](/public/assets/images/cf-fastip-11.webp)
...
![](/public/assets/images/838f685e-3913-4b21-995e-5ee149f4bffa.webp)
...
![](/public/assets/images/cf-fastip.png)

最后写一条DNS解析到想要的优选域名，完事！

![](/public/assets/images/cf-fastip-1.png)
...
![](/public/assets/images/56752d54-26a5-46f1-a7d9-a782ad9874cb.webp)

类似这样填写：

![](/public/assets/images/d025398c-39e3-4bd7-8d8f-2ce06a45007d.webp)
...
![](/public/assets/images/cf-fastip-4.png)

接着，你需要绑定一个自定义域

![](/public/assets/images/cf-fastip-5.png)

接着，前往你的域名 - 规则 - Cloud Connector

![](/public/assets/images/cf-fastip-6.png)

![](/public/assets/images/cf-fastip-7.png)

![](/public/assets/images/cf-fastip-8.png)
...
![](/public/assets/images/cf-saas-1.webp)

![](/public/assets/images/cf-saas-2.webp)

![](/public/assets/images/cf-saas-3.webp)

Worker中的路由规则也适用：

![](/public/assets/images/cf-saas-4.webp)
...
> ![](/public/assets/images/cf-fastip-1.webp)
...
![](/public/assets/images/cf-fastip.webp)

#### 具体步骤

1. 首先新建一个DNS解析，指向你的**源站**，**开启cf代理**
   ![QmfBKgDe77SpkUpjGdmsxqwU2UabvrDAw4c3bgFiWkZCna.webp](/public/assets/images/c94c34ee262fb51fb5697226ae0df2d804bf76fe.webp)
...
3. 点击添加自定义主机名。设置一个自定义主机名，比如 `onani.cn`，然后选择**自定义源服务器**，填写第一步的域名，即 `xlog.acofork.cn`。
   ...
   ![QmRYrwjeDMDQCj8G9RYkpjC3X4vpwE77wpNpbqKURwBber.webp](/public/assets/images/f6170f009c43f7c6bee4c2d29e2db7498fa1d0dc.webp)

4. 继续在你的辅助域名添加一条解析。CNAME到优选节点：如cloudflare.182682.xyz，**不开启cf代理**
   ![QmNwkMqDEkCGMu5jsgE6fj6qpupiqMrqqQtWeAmAJNJbC4.webp](/public/assets/images/4f9f727b0490e0b33d360a2363c1026003060b29.webp)

5. 最后在你的主力域名添加解析。域名为之前在辅助域名的自定义主机名（onani.cn），目标为刚才的cdn.acofork.cn，**不开启cf代理**
   ![QmeK3AZghae4J4LcJdbPMxBcmoNEeF3hXNBmtJaDki8HYt.webp](/public/assets/images/6f51cb2a42140a9bf364f88a5715291be616a254.webp)

6. 优选完毕，确保优选有效后尝试访问
   ![](/public/assets/images/cf-fastip-10.webp)
...
2. 如果是外域，SaaS后再添加路由即可，就像：
   ![](/public/assets/images/cf-fastip-12.webp)

   ![](/public/assets/images/cf-fastip-13.webp)

# 针对于Cloudflare Tunnel（ZeroTrust）

请先参照 [传统SaaS优选](#传统saas优选) 设置完毕，源站即为 Cloudflare Tunnel。正常做完SaaS接入即可：

![](/public/assets/images/cf-fastip-3.webp)

![](/public/assets/images/cf-fastip-2.webp)
...
![](/public/assets/images/cf-fastip-3.png)
